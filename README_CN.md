...
本项目基于 [Karpathy 的 LLM Wiki 模式](https://github.com/karpathy/llm-wiki) —— 一套使用 LLM 构建个人知识库的方法论。我们将其核心理念实现为一个完整的桌面应用，并做了大量增强。

## 致谢

基础方法论来自 **Andrej Karpathy** 的 [llm-wiki.md](https://github.com/karpathy/llm-wiki)，描述了使用 LLM 增量构建和维护个人 Wiki 的设计模式。原始文档是一个抽象的设计范式；本项目是一个具体的实现，并有大量扩展。
